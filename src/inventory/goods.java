...
public class goods extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel14.setText("Reatil price");

        jLabel15.setText("Quantity");

        jLabel16.setText("UP Code");

        jLabel17.setText("Status");

        txtdsc.setColumns(20);
        txtdsc.setRows(5);
        jScrollPane2.setViewportView(txtdsc);

        txtcat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { " " }));

        txtvendor.setModel(new javax.swing.DefaultComboBoxModel(new String[] { " " }));
        ...
        txtupcode.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtupcodeActionPerformed(evt);
            }
        });
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        ...
                                        .addGap(49, 49, 49)
                                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(txtstatus, 0, 159, Short.MAX_VALUE)
                                            .addComponent(txtupcode)))
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGap(18, 18, 18)
                                .addComponent(txtcostp, javax.swing.GroupLayout.PREFERRED_SIZE, 214, javax.swing.GroupLayout.PREFERRED_SIZE)))
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(txtupcode, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))))
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "GoodName", "Description", "Date", "Category", "Vendor", "Costprice", "Retailprice", "Qty", "UPCode", "Status"
            }
        ) {
   ...
   private void loadCtegory()
   {
        try {
            ...
            java.util.logging.Logger.getLogger(goods.class.getName()).log(Level.SEVERE, null, ex);
   ...
   private void loadVendor()
   {
    ...
    private void update_table()
    {
        try {
            ...
            try {
                ...
                pst = con1.prepareStatement( "select g.id,g.goodName,g.description,g.date,c.category,v.vendor,g.cost_price,g.retail_price,g.qty,g.up_code,g.status from goods g,category c,vendors v  where g.cat_id = c.id  and g.vendor_id = v.id");
                java.sql.ResultSet rs = pst.executeQuery();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String goodname = txtgood.getText();
        String description = txtdsc.getText();
        String date = txtdate.getText();
        CategoryItem catitem = (CategoryItem)txtcat.getSelectedItem();  
        VendorItem venitem = (VendorItem)txtvendor.getSelectedItem();
        String costp = txtcostp.getText();
        String retailp = txtretailp.getText();
        String quantity = txtqty.getText();
        String upcode = txtupcode.getText();
        ...
        try {
            Class.forName("com.mysql.cj.jdbc.Driver");
            con1 = DriverManager.getConnection("jdbc:mysql://localhost/trackwise","root","");
            pst = con1.prepareStatement("insert into goods(goodName,description,date,cat_id,vendor_id,cost_price,retail_price,qty,up_code,status)values(?,?,?,?,?,?,?,?,?,?)");
            pst.setString(1, goodname);
            pst.setString(2, description);
             pst.setString(3, date);
            pst.setInt(4, catitem.id);
            pst.setInt(5, venitem.id);           
            pst.setString(6, costp);
            pst.setString(7, retailp);
            pst.setString(8, quantity);
            pst.setString(9, upcode);
            pst.setString(10, status);
            
  
            
            pst.executeUpdate();
            JOptionPane.showMessageDialog(null, "Good Added Succesfully");
            update_table();
            txtgood.setText("");
            txtdsc.setText("");
            txtdate.setText("");
            txtcat.setSelectedIndex(-1);        
            txtvendor.setSelectedIndex(-1);           
            txtcostp.setText("");
            txtretailp.setText("");
            txtqty.setText("");
            txtupcode.setText("");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            Class.forName("com.mysql.cj.jdbc.Driver");
            con1 = DriverManager.getConnection("jdbc:mysql://localhost/trackwise","root","");
            pst = con1.prepareStatement("update goods set goodName=?,description=?,date=?,cat_id=?,vendor_id=?,cost_price=?,retail_price=?,qty=?,up_code=?,status=? where id=?");
            pst.setString(1, goodname);
            pst.setString(2, description);
            pst.setString(3, date);
            pst.setInt(4, catitem.id);
            ...
            pst.setString(10, status);
             ...
             pst.setInt(11, id);
            pst.executeUpdate();
            JOptionPane.showMessageDialog(null, "Goods Updated Succesfully");
            update_table();
            txtgood.setText("");
            txtdsc.setText("");
            txtdate.setText("");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
         ...
         if(dialogResult == JOptionPane.YES_OPTION)
         {
            ...
            Class.forName("com.mysql.cj.jdbc.Driver");
            con1 = DriverManager.getConnection("jdbc:mysql://localhost/trackwise","root","");
            pst = con1.prepareStatement("delete from goods where id=?");
            pst.setInt(1, id);
            pst.executeUpdate();
            JOptionPane.showMessageDialog(null, "Goods Deleted !");
            update_table();
            txtgood.setText("");
            txtdsc.setText("");
            txtdate.setText("");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        txtgood.setText(d1.getValueAt(selectIndex, 1).toString());
        txtdsc.setText(d1.getValueAt(selectIndex, 2).toString());
        txtcat.setSelectedItem(d1.getValueAt(selectIndex, 3).toString());
        txtdate.setText(d1.getValueAt(selectIndex, 4).toString());
        txtvendor.setSelectedItem(d1.getValueAt(selectIndex, 5).toString());
        ...
        txtupcode.setText(d1.getValueAt(selectIndex, 9).toString());   
        txtstatus.setSelectedItem(d1.getValueAt(selectIndex, 10).toString());
    ...
    private void txtupcodeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtupcodeActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtupcodeActionPerformed
